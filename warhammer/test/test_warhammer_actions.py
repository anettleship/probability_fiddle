...
def test_ranged_attack_action_properties():
    ...
    assert attack_action.attacker == attacker, (
        "Attacker should be the unit that performs the attack"
    )
    assert attack_action.target == target, (
        "Target should be the unit that is being attacked"
    )
    assert attack_action.weapon == ranged_weapon, (
...
def test_melee_attack_action_properties():
    ...
    assert attack_action.weapon == melee_weapon, (
        "Weapon should be the weapon used in the attack"
    )
